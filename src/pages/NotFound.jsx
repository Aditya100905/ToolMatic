...
export default function NotFound({ theme }) {
  ...
  const baseButtonClasses = "px-6 py-3 rounded-lg transition-all duration-300 font-medium shadow-lg transform hover:scale-105";
  ...
  return (
    <div className={`flex flex-col items-center justify-center min-h-screen w-full ${isDarkMode ? 'bg-black text-white' : 'bg-gray-100 text-gray-800'}`}>
      <div className="w-full max-w-2xl px-4 py-16 text-center">
        
        <div className={`text-9xl font-bold mb-4 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`}>
          404
        </div>
