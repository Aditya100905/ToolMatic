...
export default function JSFormatter() {
    ...
    const [fileName, setFileName] = useState("formatted.js");
    ...
    const handleBeautify = () => {
        try {
            ...
            toast.error("Invalid JavaScript code.");
        }
    };
    ...
    const handleDownload = () => {
        ...
        downloadLink.current.download = fileName.endsWith(".js") ? fileName : `${fileName}.js`;
